...
describe('EvoUiClass binding to CSS class list', () => {
    ...
    function prefixClassNames(classes) {
        ...
        return normalizeClassNames(classes)
            .split(' ')
            .map((k) => prefix + '_' + k)
            .join(' ');
    }
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [EvoUiClassDirective, TestComponent],
        });
    });
    ...
    describe('expressions evaluating to objects', () => {
        ...
        it('should add classes specified in an object literal without change in class names', waitForAsync(() => {
            fixture = createTestComponent(
                `<div class="${prefix}" [evoUiClass]="{'foo-bar': true, 'fooBar': true}"></div>`,
            );
        ...
        it('should add and remove classes based on changes in object literal values', waitForAsync(() => {
            fixture = createTestComponent(
                `<div class="${prefix}" [evoUiClass]="{foo: condition, bar: !condition}"></div>`,
            );
    ...
    describe('expressions evaluating to lists', () => {
        it('should add classes specified in a list literal', waitForAsync(() => {
            fixture = createTestComponent(
                `<div class="${prefix}" [evoUiClass]="['foo', 'bar', 'foo-bar', 'fooBar']"></div>`,
            );
