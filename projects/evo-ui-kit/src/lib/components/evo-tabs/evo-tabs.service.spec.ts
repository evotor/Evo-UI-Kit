...
describe('EvoToastService', () => {
    ...
    it('should return tabs group subscriptions in each time when tabs group tabs state changes', () => {
        // let eventCounter = 0;
        // service.getGroupEventsSubscription(groupName).subscribe({
        //     next: (tabGroup) => eventCounter ++,
        //     complete: () => expect(eventCounter).toEqual(3)
        // });
        //
        // service.registerTabsGroup(groupName);
        // const group = service.getRegisteredTabsGroup(groupName);
        ...
        // // change tab in group
        // tab.isActive = false;
        // anotherTab.isActive = true;
        // service['tabsState$'].next(service['tabsGroupsMap']);
        //
        // // change tab in group
        // tab.isActive = true;
        // anotherTab.isActive = false;
        // service['tabsState$'].next(service['tabsGroupsMap']);
        //
        // service['tabsState$'].complete();
    });
