...
export const Colors = () => ({
    template: `
            ...
            <div class="container container_dark">
              ...
              <div class="container container_dark">
                <h2 class="evo-text-header evo-text-header_h2 title">Customization</h2>
                ...
                <div class="inner-container">
                    ...
                    <div class="chips-list chips-list_dark">
                        <evo-chip style="${colors}" type="checkbox" value="1">Chip 1</evo-chip>
                        <evo-chip style="${colors}" type="checkbox" value="2">Chip 2</evo-chip>
                        <evo-chip style="${colors}" type="checkbox" value="3">Chip 3</evo-chip>
                    </div>
                </div>
                ...
                <div class="inner-container">
                    ...
                    <div class="chips-list chips-list_dark">
                        <evo-chip style="${colors}" size="large" type="checkbox" value="1">Chip 1</evo-chip>
                        <evo-chip style="${colors}" size="large" type="checkbox" value="2">Chip 2</evo-chip>
                        <evo-chip style="${colors}" type="label" size="large" type="checkbox" value="3">Chip 3</evo-chip>
                    </div>
                </div>
             </div>
        `,
