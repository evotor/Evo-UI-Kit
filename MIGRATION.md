...
- Если вы не переопределяли видимость этих частей - ничего делать не нужно.
...
На 100 строк это давало сотни скрытых компонентов и спроецированных view, которые жили в DOM и в change detection на десктопе (где подпись скрыта через `display: none`) - это и был основной источник фризов больших таблиц.
