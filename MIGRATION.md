...
- Если вы не переопределяли видимость этих частей и не полагались на порядок подсветки строк - менять в своём коде ничего не нужно, но сама таблица ведёт себя иначе (пункт ниже - про поведение по умолчанию, а не про ваши правки).
